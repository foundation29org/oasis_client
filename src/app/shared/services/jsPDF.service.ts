...
export class jsPDFService {
    ...
    private newHeatherAndFooter(doc){
        ...
        doc.addImage(logoHealth, 'png', 20, 284, 32, 11);
        doc.setFont(undefined, 'normal');
        doc.setFontSize(10);
        doc.setTextColor(51, 101, 138)
        doc.textWithLink("https://oasisgpt.azurewebsites.net", 148, 290, { url: 'https://oasisgpt.azurewebsites.net' });
        doc.setTextColor(0, 0, 0);
    }
    ...
    generateResultsPDF(entryText, infoDiseases, lang){
        ...
        doc.addImage(img_logo, 'png', 10, 13, 22, 16);
        doc.setFont(undefined, 'normal');
        doc.setFontSize(10);
       ...
       //Add QR
        ...
        this.newSectionDoc(doc,'Texte de saisie du patient','',null,lineText += 10)
        lineText += 5;
        ...
        doc.save('OasisGPT_Report_' + date + '.pdf');
